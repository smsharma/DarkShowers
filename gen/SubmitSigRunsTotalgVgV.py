...
for MZp in masses:
    for rinv in rinv_ary:    
        fname_tag = "/group/hepheno/smsharma/Dark-Showers/gen_lhe/total_gvgv/gvgvjj_" + str(MZp) + ".lhe -metmin 0 -n 200000 -phimass 10 -lambda 5 -v "
        rinv_tag = "-inv " + str(rinv)
        out_tag = "-o " + "tchannelTotal_gVgV/tchannel_down_"+str(MZp)+"_rinv" + str(rinv)
