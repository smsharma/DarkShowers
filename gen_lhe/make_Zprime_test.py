...
prefix = "zprime_direct" # Prefix that the MG job was generated with
nevt_each = 20000 # Number of events in each job
...
# for i in [5]:
	...
	batchn += "sed -i 's/<ZpMass>/"+str(i)+"/g' ../Cards/param_card.dat\n" # Change seed in MG run card
	...
	batchn += "sed -i 's/49001010/5000521/g' ../Events/run_01/unweighted_events.lhe\n" # Change events in MG run card	
