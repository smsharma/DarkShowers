...
for i in range(n_jobs):
	...
	batchn += "./monojet.exe -m lhe -w -i " + mg_dir + prefix + "_" + str(i) + "/Events/run_01/unweighted_events.lhe -metmin 0 -Zprime -n 500000 -o bkg_ttbar_dilep_" + str(i) + " -nmatch " + str(nmatch) + "\n"
