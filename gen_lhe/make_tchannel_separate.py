...
bkg_prefix = ["sig_tchannel_direct", "sig_tchannel_chiphi","sig_tchannel_phiphi"]

mdark = 10 # Dark quark mass in GeV

nevents = 100000 # Events per job
ijobs = [0, 0, 0] # Start index
njobs = [1, 1, 1] # Number of jobs to submit
 # Prefix that the MG job was generated with
nmatch = [2, 2, 2] # Pythia nmatch parameter
recluster = False # Whether to recluster jets in pythia
hepmc = False
masses_to_run = [1000,10000,100000]
...
# masses = [list(np.arange(500,3000,100)),[]]
masses = [masses_to_run,masses_to_run,masses_to_run]
# masses = [[],[100000]]
