...
./monojet.exe -m lhe -w -i /group/hepheno/heptools/MG5_aMC_v2_5_2/bin/DMsimp_s1_500/Events/run_01/unweighted_events.lhe -metmin 0 -n 200000 -phimass 500 -lambda 250 -v '''
...
for rinv in rinv_ary:    
    ...
    out_tag = "-o " + "monojet_500_rinv" + str(rinv)
    tag = rinv_tag + " " + out_tag
    print tag
    batchn = batch + tag
    fname = "batch/run_monojet_500_"+str(rinv)+".batch"
    f=open(fname, "w")
    f.write(batchn)
    f.close()
