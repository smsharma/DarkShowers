...
nevents = 5000
ijobs = 399
njobs = 4001 # Number of jobs to submit
prefix = "bkg_qcd" # Prefix that the MG job was generated with
...
# os.system("rm -rf " + mg_dir + prefix + "/gridpack_*") # Remove all previous runs

# Make folder for final ntuples
if not os.path.exists(data_dir + prefix):
	os.mkdir(data_dir + prefix)

for i in range(ijobs, njobs):
