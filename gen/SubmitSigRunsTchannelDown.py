...
for MZp in masses:
    for rinv in rinv_ary:    
        fname_tag = "/group/hepheno/smsharma/Dark-Showers/MG5_aMC_v2_5_2/bin/tch_associated_down_" + str(MZp) + "/Events/run_01/unweighted_events.lhe -metmin 0 -n 200000 -phimass 10 -lambda 5 -v "
        rinv_tag = "-inv " + str(rinv)
        out_tag = "-o " + "tchannelEventsAssoc/tchannel_down_"+str(MZp)+"_rinv" + str(rinv)
