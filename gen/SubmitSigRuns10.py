...
./monojet.exe -m lhe -w -i /group/hepheno/heptools/MG5_aMC_v2_5_2/bin/DMsimp_s1_10/Events/run_01/unweighted_events.lhe -metmin 0 -n 500000 -phimass 10 -lambda 5 '''
...
for rinv in rinv_ary:    
    ...
    out_tag = "-o " + "monojet_10_rinv" + str(rinv)
    tag = rinv_tag + " " + out_tag
    print tag
    batchn = batch + tag
    fname = "batch/run_monojet_10_"+str(rinv)+".batch"
    f=open(fname, "w")
    f.write(batchn)
    f.close()
