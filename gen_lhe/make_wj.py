...
prefix = "bkg_Wj" # Prefix that the MG job was generated with
nevt_each = 100 # Number of events in each job
...
for i in range(n_jobs):
	...
	batchn += "sed -i 's/1000 = nevents/"+str(nevt_each)+" = nevents/g' ../Cards/run_card.dat\n" # Change events in MG run card
	...
	batchn += "./monojet.exe -m lhe -w -i " + mg_dir + prefix + "_" + str(i) + "/Events/run_01/unweighted_events.lhe -metmin 0 -n 2000000 -o bkg_Zj_" + str(i) + " -nmatch " + str(nmatch) + "\n"
