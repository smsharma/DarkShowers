...
#ifndef higgsportal_H
#define higgsportal_H
...
class Sigma1gg2Theta : public Sigma2Process {

public:

  // Constructor.
  Sigma1gg2Theta(int id=663): idTheta(id) {}
  ...
  virtual string name()       const {return "g g -> h* -> Theta Theta";}
  ...
  virtual int id3Mass()  const {return idTheta;}
  virtual int id4Mass()  const {return idTheta;}
