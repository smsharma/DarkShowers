...
# for i in :
masses = [500,1000,2000,3000,4000,5000,10000,20000,50000,100000]
# masses = [100000]
# masses = [500,1000,2000,3000,4000]
for MZp in masses:
    for rinv in rinv_ary:    
        fname_tag = "/group/hepheno/smsharma/Dark-Showers/MG5_aMC_v2_5_2/bin/zprime_wtf_pp_" + str(MZp) + "/Events/run_02/unweighted_events.lhe -metmin 0 -n 200000 -phimass 10 -lambda 5 -v "
        rinv_tag = "-inv " + str(rinv)
        out_tag = "-o " + "ZprimeDirectFinal/zprime_direct_M"+str(MZp)+"_rinv" + str(rinv)
