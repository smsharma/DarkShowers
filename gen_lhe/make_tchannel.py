...
prefix = "tchannel_wtf_pp" # Prefix that the MG job was generated with
...
# for i in [5]:
	...
	batchn += "gunzip " + mg_dir + prefix+"_" + str(i) +"/Events/run_02/unweighted_events.lhe.gz\n" # Unzip created LHE file
	batchn += "sed -i 's/49001010/4900101/g' ../Events/run_02/unweighted_events.lhe\n" # Change events in MG run card	
	batchn += "sed -i 's/49001011/4900101/g' ../Events/run_02/unweighted_events.lhe\n" # Change events in MG run card	
	batchn += "sed -i 's/49001012/4900101/g' ../Events/run_02/unweighted_events.lhe\n" # Change events in MG run card	
	batchn += "sed -i 's/49001013/4900101/g' ../Events/run_02/unweighted_events.lhe\n" # Change events in MG run card	
	batchn += "sed -i 's/49001014/4900101/g' ../Events/run_02/unweighted_events.lhe\n" # Change events in MG run card	
