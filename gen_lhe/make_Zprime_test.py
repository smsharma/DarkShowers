...
prefix = "zprime_wtf_pp" # Prefix that the MG job was generated with
...
# for i in [5]:
	...
	# batchn += "sed -i 's/<ZprimeMass>/"+str(i)+"/g' ../Cards/param_card.dat\n" # Change seed in MG run card
	...
	batchn += "sed -i 's/5000521/4900101/g' ../Events/run_02/unweighted_events.lhe\n" # Change events in MG run card	
